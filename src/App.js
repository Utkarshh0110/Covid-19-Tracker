...
function App() {
  ...
  // If array is blank then it will only load once when the component loads.
  ...
  const onCountryChange = async (event) => {
    ...
    //Pulling the data for the specific country.
    ...
    await fetch(url)
      ...
      .then((data) => {
        setCountry(countryCode);
        //Storing the whole object, that's why in state it is object
        setCountryInfo(data);
